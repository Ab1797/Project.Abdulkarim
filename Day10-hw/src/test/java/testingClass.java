...
public class testingClass {
    ...
    @BeforeEach
    public void init(){
        student1 = new Students("Ali", 23, "Riyadh", 12345, "Computer Science");
        student2 = new Students("Sara", 22, "Jeddah", 12346, "Mathematics");
        student3 = new Students("Omar", 24, "Dammam", 12347, "Physics");
    ...
    public void testStudents(){
        s1 = new Students("Abdulrhman", 18, "Tabuk", 123, "JAVA");
    ...
    public void testSortStudentsByName() {
        ...
        Assertions.assertEquals("Ali", school.getStudents().get(0).getName());
        Assertions.assertEquals("Omar", school.getStudents().get(1).getName());
        Assertions.assertEquals("Sara", school.getStudents().get(2).getName());
    }
